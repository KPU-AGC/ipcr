...
func toAPIProbeThermo(src *engine.ProbeThermoDetails) *api.ProbeThermoV1 {
	...
	return &api.ProbeThermoV1{
		...
		MismatchSources:                 append([]string(nil), src.MismatchSources...),
		MismatchParameterSets:           append([]string(nil), src.MismatchParameterSets...),
		MismatchCitations:               append([]string(nil), src.MismatchCitations...),
		MismatchParameterNotes:          append([]string(nil), src.MismatchParameterNotes...),
		...
		TerminalMismatchSources:         append([]string(nil), src.TerminalMismatchSources...),
		TerminalMismatchParameterSets:   append([]string(nil), src.TerminalMismatchParameterSets...),
		TerminalMismatchCitations:       append([]string(nil), src.TerminalMismatchCitations...),
		TerminalMismatchParameterNotes:  append([]string(nil), src.TerminalMismatchParameterNotes...),
